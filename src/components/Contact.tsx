...
// //             <div className="space-y-8 mt-12 relative z-10">
// //               {[
// //                 { icon: <Mail size={20} />, text: "magomboanaclet@gmail.com" },
// //                 { icon: <Phone size={20} />, text: "+265 899 567 169" },
// //                 { icon: <MapPin size={20} />, text: "Lilongwe, Malawi" }
// //               ].map((item, i) => (
// //                 <div key={i} className="flex items-center gap-4 group">
// //                   <div className="w-12 h-12 rounded-full bg-white flex items-center justify-center shadow-lg transition-transform group-hover:scale-110 text-[#10B981]">
...
// //                 <p className="text-sm font-bold text-[#10B981] bg-[#10B981]/10 px-4 py-2 rounded-xl animate-fade-in">
...
//           {/* LEFT SIDE: INFO WITH DYNAMIC INTERACTIVE LINKS */}
//           <div className="w-full md:w-[40%] bg-[#10B981] p-12 md:p-16 flex flex-col justify-between relative overflow-hidden">
//             <div className="absolute top-0 right-0 w-64 h-64 bg-white/10 rounded-full blur-3xl -mr-32 -mt-32" />
...
import React, { useState, useRef, useEffect } from "react";
import { Mail, Phone, MapPin, ChevronDown, Send, Check, Loader2 } from "lucide-react";
import Modal from "./Modal"; // FIXED: Importing your custom global Modal component here
